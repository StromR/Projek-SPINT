    ...
    <div id="wrapper">
        ...
        <div class="bg-dark rounded" id="left-sidebar-wrapper">
            ...
            <div class="text-center">
                <a href="" data-toggle="modal" data-target="#addPhoto"><img src="<?php echo $row['profile_picture'] ?>"
                        alt="profile picture" class="rounded" id="foto"></a>
        ...
        <!-- Modal -->
        <div class="modal fade" id="addPhoto" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
        ...
        <div class="rounded text-left" id="right-sidebar-wrapper">
            ...
            <div class="card-body rounded" id="tournament">
                ...
                <ul class="list-group">
                    <li class="list-group-item" id="list-tour"><img src="assets/icon/dota.svg" alt="dota"
                            class="w-25 mx-1">
                        The International</li>
                    <li class="list-group-item" id="list-tour"><img src="assets/icon/csgo.svg" alt="cssgo"
                            class="w-25 mx-1">
                        CSGO Major</li>
                    <li class="list-group-item" id="list-tour"><img src="assets/icon/ml.svg" alt="ml" class="w-25 mx-1">
                        M2
                    </li>
                </ul>
            </div>
            ...
            <div class="card-body rounded" id="transfer">
                ...
                <ul class="list-group">
                    <li class="list-group-item" id="list-tour"><img src="assets/trf-1.png" alt="ml" class="w-100 mx-1">
                    </li>
                    <li class="list-group-item" id="list-tour"><img src="assets/trf-2.png" alt="csgo"
                            class="w-100 mx-1"></li>
                    <li class="list-group-item" id="list-tour"><img src="assets/trf-3.png" alt="dota"
                            class="w-100 mx-1"></li>
                </ul>
            </div>
        </div>
        ...
        <div id="page-content-wrapper">
                                ...
                                <div class="col bg">
                                    <form method="post" action="post.php" enctype="multipart/form-data">
                                        <div class="form-group mb-0">
                                            <textarea class="form-control bg-dark" id="textarea-write" name="content"
                                                rows="2" placeholder="Write here"></textarea>
                                        </div>
                                        <div class="card-footer p-2">
                                            <div class="d-flex justify-content-between align-items-center text-center">
                                                <div class="col">
                                                    <img class="text-center" src="assets/icon/photo.svg" alt="photo"
                                                        class="mx-1 bg">
                                                ...
                                                <div class="col">
                                                    <button type="button"
                                                        class="btn btn-fposts btn-block btn-sm bg-dark"
                                                        id="write-footer"><img src="assets/icon/location.svg"
                                                            alt="location" class="mx-1 bg"> Share location</button>
                                                </div>
                                                <div class="col">
                                                    <button type="button"
                                                        class="btn btn-fposts btn-block btn-sm bg-dark"
                                                        id="write-footer"><img src="assets/icon/tag.svg" alt="photo"
                                                            class="mx-1 bg"> Tag Players</button>
                                                </div>
                                            </div>
                                        </div>
                                        <button class="btn btn-outline-danger" id="right" name="Submit"
                                            value="Log out">Submit</button>
                                    </form>
                                </div>
            ...
            ?>
                    ...
                    <div class="card my-3 bg-dark">
                            ...
                            <div class="d-flex justify-content-between">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div class="ml-3">
                                        ...
                                        <div class="text-muted h8 bg-dark"><?php echo $time = time_stamp($time); ?>o
                                        </div>
                                    </div>
                                </div>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                                        <a class="dropdown-item"
                                            href="delete_post.php<?php echo '?id='.$post_id; ?>">Delete</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <a href="#" class="pop">
                            <img class="card-img-top rounded-0" src="<?php echo $location ?>" alt="post" id="postimg"
                                style="width: 100%;">
                        </a>
                        ...
                        <div class="card-footer bg-dark border-0 p-2">
                            <div class="d-flex justify-content-between align-items-sm-start my-1">
                                <div class="col bg-dark">
                                    <button type="button" class="btn btn-fbook btn-block btn-sm bg-dark mx-1"
                                        id="write-footer"><img src="assets/icon/like-active.svg" alt=""> Like
                                        100</button>
                                </div>
                                <div class="col">
                                    <button type="button" class="btn btn-fbook btn-block btn-sm bg-dark mx-1"
                                        id="write-footer"><img src="assets/icon/comment.svg" alt=""> Comment</button>
                                </div>
                                <div class="col">
                                    <button type="button" class="btn btn-fbook btn-block btn-sm bg-dark mx-1"
                                        id="write-footer"><img src="assets/icon/share.svg" alt=""> Share</button>
                                </div>
                            </div>
                        </div>
