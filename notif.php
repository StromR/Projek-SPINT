           ...
           py-2 sticky-top rounded" id="sidebar">
            ...
            <div class="collapse navbar-collapse proder-last" id="nav">
              <ul class="navbar-nav flex-column w-100 justify-content-center">
                ...
                <li>
                  <a href="notif.html" class="nav-link active"><img src="assets/icon/notif_active.svg" height="50px" width="50px" alt="notification"> Notification</a>
                </li>
                <hr><hr><hr><hr><hr><hr>
                <li>
           ...
           <div class="row align-items-center">
             <div class="col-sm-auto" style="color: white;">
              ...
              <div class="form-group">
                <label class="d-block">SPINT Notifications</label>
                <ul class="list-group list-group-sm">
                  <li class="list-group-item has-icon" style="color: #15131E;">
                    Comments
