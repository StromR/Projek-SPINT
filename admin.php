    ...
    <div id="wrapper">
        ...
        <div class="bg-dark rounded" id="left-sidebar-wrapper">
            ...
            <div class="text-center">
                <a href="updatephoto.php"><img src="<?php echo $row['profile_picture'] ?>" alt="profile picture"
                        class="rounded" id="foto"></a>
                                        ...
                                        <div class="col-md-3 mt-4">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
                                                    <button class="dropdown-item" type="submit" name="rank_d">MMR
                                                        Desc</button>
                                                    <button class="dropdown-item" type="submit" name="rank_a">MMR
                                                        Asc</button>
                                                    <button class="dropdown-item" type="submit" name="user_d">Username
                                                        Desc</button>
                                                    <button class="dropdown-item" type="submit" name="user_a">Username
                                                        Asc</button>
                                                </div>
                                            </div>
                                        </div>
